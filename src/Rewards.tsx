...
const Rewards: React.FC = () => {
    ...
    return (
        <>
                ...
                <div className="flex h-headerDiv justify-center items-center mt-4 flex-col">
                    ...
                    <div className="px-4 text-center">
                        <small className="text-s font-small leading-none text-center">
                            Redeem your free trip to have your next bus trip fee
                            waived by AT HOP
                        </small>
                    </div>
                </div>
            </div>
            <div className="greenscreen h-greenDiv px-4 pt-4 pb-[250px] rounded-tl-[30px] rounded-tr-[30px] mt-4">
            ...
            <NavigationBar navigationTab={NavigationTab.FreeTrips} />
        </>
    )
}
