    ...
    return (
        <>
            ...
            <div className='p-2 pt-0'>
                <div className='flex'>
                    <svg width="120" height="120" viewBox="5 20 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="mt-0 scroll-m-20 text-xl font-semibold tracking-tight">
                    Bus Points: Level 3
                </h3>
