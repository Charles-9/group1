    ...
    return (
        <>
            <div className="pt-2 pr-4 pl-4">
                <div className="flex pt-10 h-headerDiv">
                    {/* <svg
                        width="130"
                        height="90"
            ...
            <div className="greenscreen h-greenDiv px-4 pb-20 rounded-tl-[30px] rounded-tr-[30px] mt-0 custom-gradient">
                <h3 className="mt-0 pt-6 scroll-m-20 text-xl font-semibold tracking-tight">
                    Bus Points: Level 3
                </h3>
            ...
            <NavigationBar navigationTab={NavigationTab.Profile} />
        </>
    )
}
